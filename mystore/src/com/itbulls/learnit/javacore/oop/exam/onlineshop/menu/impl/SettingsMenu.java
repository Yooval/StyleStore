...
// This file allows users to manage account settings like email and password.
    ...
    public void start() {
        ...
        mainLoop: while (true) {
            ...
            if (context.getLoggedInUser() == null) {
                System.out.println(
                        "Please, log in or create a new account to change your account settings");
                new MainMenu().start();
                return;
            } else {
                ...
                // Check if the user typed "menu" to navigate back
                ...
                switch (userOption) {
                    ...
                    case 2:
                        ...
                        break mainLoop;
                    default:
                        System.out.println("Only 1, 2 is allowed. Try again.");
                        continue;
                }
            }
        }
